...
#define STRING_CONFIG_H_AUTHOR "(Martin Kremers, default config)" // Who made the changes.
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 11          // Mesh inset margin on print area
